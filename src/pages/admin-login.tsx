    ...
    <div className="min-h-screen bg-white">
      <div className="px-6 py-8 max-w-md mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-extrabold" style={{ color: 'rgb(11, 26, 81)' }}>
            Sign In
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-14 py-4 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base"
                style={{ borderRadius: '25px' }}
          ...
          <div className="text-center mb-5">
            <span className="text-sm font-light" style={{ color: 'rgb(19, 19, 19)' }}>Forgot password? </span>
            <a href="#" className="text-sm font-bold hover:underline" style={{ color: 'rgb(11, 26, 81)' }}>
              Reset password
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full text-white py-4 px-4 font-medium hover:bg-blue-900 transition duration-200 mb-10"
            style={{ 
        ...
        <div className="flex items-center mb-5">
          ...
          <span className="px-2 text-sm font-light" style={{ color: 'rgb(19, 19, 19)' }}>
            or continue with
          </span>
          <div className="flex-1 border-t border-black"></div>
        </div>
        ...
        <div className="flex justify-center space-x-5 mb-5">
          <button className="w-14 h-14 border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition duration-200"
        ...
        <div className="text-center">
          <span className="text-sm font-light" style={{ color: 'rgb(19, 19, 19)' }}>
